 ...
 *
 * ЛКМ: удар по цели рассекает и всех врагов рядом; взмах рисуется ОДНИМ
 * большим анимированным слэшем (частица {@code hell_yeah_stuff:slash}).
 *
 ...
 * срабатывает ВТОРОЙ, перпендикулярный разрез — тоже один большой
 * анимированный слэш ({@code hell_yeah_stuff:slash_judgment}). Перемещения (рывка) нет.
 */
public class HalberdItem extends SwordItem {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (level instanceof ServerLevel server) {
            ...
            // Один большой анимированный разрез в центре области (не три отдельных).
    ...
    public static void performSecondCut(ServerLevel server, @Nullable Player attacker, Vec3 center) {
        ...
        // Один большой перпендикулярный разрез (не три отдельных).
