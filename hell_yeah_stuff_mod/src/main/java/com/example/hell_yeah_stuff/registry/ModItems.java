...
public final class ModItems {
    ...
    // hell_yeah_stuff:slash). Медленнее и сильнее меча. ПКМ — большой
    // рубящий разрез по области; с зачарованием «Judgment Cut» через секунду
    // добавляется второй, перпендикулярный разрез.
